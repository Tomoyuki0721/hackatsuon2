 ...
 * 事業データが複数件揃った段階で実装する(Phase 8以降、現状は資料記載なし扱いとしない
 * ─ 単純に「準備中」と明示する)。
 */
export default function HomePage() {
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-10">
            ...
            {projects.map((p) => (
              <li key={p.projectId}>
                <Link
                  ...
                  className="block rounded-xl border border-slate-200 bg-white p-4 shadow-sm transition hover:border-mode-budget hover:shadow-md"
                >
      ...
      <section className="mt-10 rounded-xl border border-dashed border-slate-300 bg-slate-50 p-5">
